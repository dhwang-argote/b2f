...
A comprehensive sports trading platform where users can participate in funded challenges to qualify for real trading accounts. Built with React/TypeScript frontend and a custom backend.
